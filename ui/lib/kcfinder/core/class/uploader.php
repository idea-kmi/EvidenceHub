...
/** Magic method which allows read-only access to protected or private class properties
  ...
  * @return mixed */
    ...
    protected function checkFilePath($file) {
		...
		// NOTE: NOT COMPATIBLE WITH SYMLINK USAGE AS WE HAVE ON WEB 20.
		// So changing the check to just return true;
        ...
        */
        ...
        /*
        error_log("1:".$file);
        error_log("2:".$this->typeDir);
        error_log("3:".$rPath);

        1:/data/web/evidencehub-root/www/sites/default/uploads/137108251921190199260/images
		2:/data/web/evidencehub-root/www/sites/default/uploads/137108251921190199260/images
		3:/data/web/evidencehub.kmi.open.ac.uk/sites/default/uploads/137108251921190199260/images
		*/
